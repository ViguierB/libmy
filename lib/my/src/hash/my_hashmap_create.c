...
** Last update Sun Oct 22 13:17:36 2017 Benjamin Viguier
*/
...
t_hashmap_value *hm_f_ss(const char *key, const char *value)
{
  return (get_hashmap_value(key, my_strlen(value), value, my_strlen(value)));
}

t_hashmap_value *hm_f_sh(const char *key, const void *value, const uint32_t value_len)
{
